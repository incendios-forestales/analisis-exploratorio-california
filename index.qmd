...
# Leer datos de temperatura 2m promedio 1980 - 2024
temperature_2m <- rast("2m_temperature_ca_promedio_1980-2024.tif")

# Renombrar las capas
names(temperature_2m) <- c(
  "1980–1984", "1985–1989", "1990–1994",
  "1995–1999", "2000–2004", "2005–2009",
  "2010–2014", "2015–2019", "2020–2024"
)

# Leer datos de temperatura del suelo promedio 1980 - 2024
skin_temperature <- rast("skin_temperature_ca_promedio_1980-2024.tif")

# Renombrar las capas
names(skin_temperature) <- c(
  "1980–1984", "1985–1989", "1990–1994",
  "1995–1999", "2000–2004", "2005–2009",
  "2010–2014", "2015–2019", "2020–2024"
)

# Leer datos de precipitación total mensual promedio 1980 - 2024
total_precipitation <- rast("total_precipitation_ca_promedio_1980-2024.tif")

# Renombrar las capas
names(total_precipitation) <- c(
  "1980–1984", "1985–1989", "1990–1994",
  "1995–1999", "2000–2004", "2005–2009",
  "2010–2014", "2015–2019", "2020–2024"
)
...
## Temperatura promedio a 2 m del suelo
...
tm_shape(temperature_2m) +
  tm_raster(
    palette = "-RdYlBu", # azules: frío, rojos: cálido
    style   = "cont",
    title   = "°C"
  ) +
  tm_facets(ncol = 3) +
...
## Temperatura promedio de la superficie del suelo

```{r}
#| label: mapa-temperatura_suelo-promedio
#| warning: false
#| message: false
#| code-fold: true
#| fig-height: 8
